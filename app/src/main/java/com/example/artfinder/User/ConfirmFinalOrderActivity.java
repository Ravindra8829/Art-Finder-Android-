...
import com.example.artfinder.Model.Cart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() != null) {
            ...
            if (activityFrom.equals("From Cart")) {
                productprice = getIntent().getStringExtra("total amount");
        ...
        addAdress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //  .putExtra("total amount", productive)
            }
        });
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                            ...
                            Log.d("the artist", "onDataChange: " + cart.getProductid());
